 ...
 *		Removed HW::updateIntTemp(), HW::internalTemp(), HW::vrefint, HW::t_stm32, HW::start_temp
 *		Modified HW::init() arguments
 */
...
class HW {
	public:
		...
		CFG_STATUS			init(uint16_t iron_temp, uint16_t gun_temp, uint16_t ambient);
